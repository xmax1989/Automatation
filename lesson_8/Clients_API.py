...
class clients:
    ...
    def post_employee(self, firname="string", laname="string", 
                      MIDname="string", CompID=0, EMAIL="string", URL="string",   
                      PHONE="string", BIRdate="2024-09-05T06:11:32.856Z"):
        client = {
            "id": 0,
            "firstName": firname, 
            "lastName": laname, 
        ...
        resp = requests.post(self.url+'/employee', json=client, headers=my_headers)
        return resp.json()
    ...
    def patch_employee_id(self, id, firname="string", laname="string",      
                      MIDname="string", CompID=0, EMAIL="string", URL="string",    
                      PHONE="string", BIRdate="2024-09-05T06:11:32.856Z", ISACT=True):
        client = {
            "id": 0,
            "firstName": firname,
            "lastName": laname,
        ...
        my_headers = {}
        my_headers["x-client-token"] = self.get_token()
        resp = requests.patch(self.url+'/employee/' + str(id), json=client, headers=my_headers)
        return resp.json()
